...
/* Songs page */
module.exports.songsInfo = function(req,res){
    res.render('songs-info', {title : "Songs Information"});
};
...
module.exports.songsInfo2= function(req,res){
    res.render('songs-info2', {title : "Songs Catalogue"});
};


module.exports.songsInfo3= function(req,res){
    res.render('songs-info3', {title : "Songs Catalogue"});
};

module.exports.songsInfo4= function(req,res){
    res.render('songs-info4', {title : "Songs Catalogue"});
};
